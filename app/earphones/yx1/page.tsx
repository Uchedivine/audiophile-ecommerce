  ...
  return (
    <main>
      ...
      <header className="bg-[#0E0E0E] border-b border-white/10 relative z-50">
        <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-[165px]">
          <div className="flex items-center justify-between h-24">
            <a href="/">
              <h1 className="text-white text-[25px] font-bold">audiophile</h1>
            </a>
      ...
      <section className="bg-white pt-[79px] md:pt-[33px]">
        <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-[165px]">
          <a href="/earphones" className="text-[15px] font-medium text-black hover:text-[#D87D4A] transition-colors">
            Go Back
          </a>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                <div className="bg-[#F1F1F1] flex items-center">
                  ...
                  <span className="px-5 py-[15px] font-bold text-[13px] text-black">
                    {quantity}
                  </span>
                  <button
            ...
            <div className="lg:col-span-2">
              ...
              <div className="text-black text-[15px] font-medium leading-[25px] space-y-6">
                <p>
                  ...
                  acoustic technology. With improved ergonomics designed for full
                  day wearing, these revolutionary earphones have been finely
                  crafted to provide you with the perfect fit, delivering
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-6">
                  ...
                  <span className="text-black text-[15px] font-medium">Earphone Unit</span>
                </li>
                <li className="flex items-start gap-6">
                  <span className="text-[#D87D4A] font-bold text-[15px] min-w-[20px]">6x</span>
                  <span className="text-black text-[15px] font-medium">Multi-size Earplugs</span>
                </li>
                <li className="flex items-start gap-6">
                ...
                <li className="flex items-start gap-6">
                  <span className="text-[#D87D4A] font-bold text-[15px] min-w-[20px]">1x</span>
                  <span className="text-black text-[15px] font-medium">USB-C Charging Cable</span>
                </li>
                <li className="flex items-start gap-6">
                  <span className="text-[#D87D4A] font-bold text-[15px] min-w-[20px]">1x</span>
                  <span className="text-black text-[15px] font-medium">Travel Pouch</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-5 lg:gap-[30px]">
            <div className="md:col-span-2 space-y-5 lg:space-y-[30px]">
              <div className="rounded-lg overflow-hidden">
                <img src="/pd15.png" alt="Product gallery image 1" className="w-full h-full object-cover" />
              </div>
              <div className="rounded-lg overflow-hidden">
                <img src="/pd16.png" alt="Product gallery image 2" className="w-full h-full object-cover" />
              </div>
            </div>
            <div className="md:col-span-3 rounded-lg overflow-hidden">
              <img src="/pd17.png" alt="Product gallery image 3" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-14 md:gap-[30px]">
            ...
            <div className="text-center">
              <div className="bg-[#F1F1F1] rounded-lg flex items-center justify-center h-[265px] md:h-[318px] mb-8 md:mb-10">
                <img src="/hd2.png" alt="XX99 Mark I" className="w-[140px] md:w-[180px] h-auto object-contain" />
              </div>
              <h3 className="text-[24px] font-bold uppercase tracking-[1.7px] mb-8 text-black">
                XX99 Mark I
              </h3>
              <a href="/headphones/xx99-mark-i">
            ...
            <div className="text-center">
              <div className="bg-[#F1F1F1] rounded-lg flex items-center justify-center h-[265px] md:h-[318px] mb-8 md:mb-10">
                <img src="/hd3.png" alt="XX59" className="w-[140px] md:w-[180px] h-auto object-contain" />
              </div>
              <h3 className="text-[24px] font-bold uppercase tracking-[1.7px] mb-8 text-black">
                XX59
              </h3>
            ...
            <div className="text-center">
              <div className="bg-[#F1F1F1] rounded-lg flex items-center justify-center h-[265px] md:h-[318px] mb-8 md:mb-10">
                <img src="/speaker1.png" alt="ZX9 Speaker" className="w-[140px] md:w-[180px] h-auto object-contain" />
              </div>
              <h3 className="text-[24px] font-bold uppercase tracking-[1.7px] mb-8 text-black">
                ZX9 Speaker
              </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-[10px] lg:gap-[30px]">
            <div className="bg-[#F1F1F1] rounded-lg flex flex-col items-center pt-[88px] pb-[22px] px-6 relative group">
              <div className="absolute -top-[52px] w-[160px] h-[160px]">
                <img src="/hd2.png" alt="Headphones" className="w-full h-full object-contain" />
              </div>
              <h3 className="text-[15px] md:text-[18px] font-bold uppercase tracking-[1.3px] text-black mt-[78px] mb-[17px]">
                Headphones
              </h3>
              <a href="/headphones" className="text-[13px] font-bold uppercase tracking-[1px] text-black hover:text-[#D87D4A] transition-colors flex items-center gap-[13px] group">
                Shop
            ...
            <div className="bg-[#F1F1F1] rounded-lg flex flex-col items-center pt-[88px] pb-[22px] px-6 relative group">
              <div className="absolute -top-[52px] w-[160px] h-[160px]">
                <img src="/speaker1.png" alt="Speakers" className="w-full h-full object-contain" />
              </div>
              <h3 className="text-[15px] md:text-[18px] font-bold uppercase tracking-[1.3px] text-black mt-[78px] mb-[17px]">
                Speakers
              </h3>
              <a href="/speakers" className="text-[13px] font-bold uppercase tracking-[1px] text-black hover:text-[#D87D4A] transition-colors flex items-center gap-[13px] group">
                Shop
                <svg width="8" height="12" viewBox="0 0 8 12" fill="none">
                  <path d="M1.32178 1L6.32178 6L1.32178 11" stroke="#D87D4A" strokeWidth="2" />
                </svg>
            ...
            <div className="bg-[#F1F1F1] rounded-lg flex flex-col items-center pt-[88px] pb-[22px] px-6 relative group">
              <div className="absolute -top-[52px] w-[160px] h-[160px]">
                <img src="/ep1.png" alt="Earphones" className="w-full h-full object-contain" />
              </div>
              <h3 className="text-[15px] md:text-[18px] font-bold uppercase tracking-[1.3px] text-black mt-[78px] mb-[17px]">
                Earphones
              </h3>
              <a href="/earphones" className="text-[13px] font-bold uppercase tracking-[1px] text-black hover:text-[#D87D4A] transition-colors flex items-center gap-[13px] group">
                Shop
                <svg width="8" height="12" viewBox="0 0 8 12" fill="none">
                  <path d="M1.32178 1L6.32178 6L1.32178 11" stroke="#D87D4A" strokeWidth="2" />
                </svg>
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-[165px]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-[125px] items-center">
            ...
            <div className="order-1 lg:order-2">
              <div className="rounded-lg overflow-hidden">
                <img src="/hp1.png" alt="Person enjoying audio gear" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-[165px]">
          ...
          <div className="pt-[48px] md:pt-[56px] lg:pt-[71px] pb-[48px]">
            <div className="flex flex-col lg:flex-row justify-between items-center mb-[48px] md:mb-[32px]">
              <a href="/">
                <h2 className="text-[25px] font-bold mb-[48px] lg:mb-0">audiophile</h2>
              </a>
