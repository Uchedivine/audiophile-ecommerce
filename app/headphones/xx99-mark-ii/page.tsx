  ...
  return (
    <main>
      ...
      <section className="bg-white pt-[79px] md:pt-[33px]">
        <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-[165px]">
          <a href="/headphones" className="text-[15px] font-medium text-black/50 hover:text-[#D87D4A] transition-colors">
            Go Back
          </a>
        </div>
      </section>
      ...
      {/* --- SECTIONS BELOW ARE COPIED FROM XX59 PAGE --- */}
      
      {/* FEATURES & IN THE BOX SECTION */}
      {/* TODO: Update this content for the XX99 Mark II */}
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-[165px]">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-[125px]">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="text-black/50 text-[15px] font-medium leading-[25px] space-y-6">
                <p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-6">
                  ...
                  <span className="text-black/50 text-[15px] font-medium">Headphone Unit</span>
                </li>
                <li className="flex items-start gap-6">
                  <span className="text-[#D87D4A] font-bold text-[15px] min-w-[20px]">2x</span>
                  <span className="text-black/50 text-[15px] font-medium">Replacement Earcups</span>
                </li>
                <li className="flex items-start gap-6">
                  <span className="text-[#D87D4A] font-bold text-[15px] min-w-[20px]">1x</span>
                  <span className="text-black/50 text-[15px] font-medium">User Manual</span>
                </li>
                <li className="flex items-start gap-6">
                  <span className="text-[#D87D4A] font-bold text-[15px] min-w-[20px]">1x</span>
                  <span className="text-black/50 text-[15px] font-medium">3.5mm 5m Audio Cable</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      {/* GALLERY SECTION */}
      {/* TODO: Update these images for the XX99 Mark II */}
      ...
      {/* NOTE: Updated this section to show XX59 instead of XX99 Mark II */}
      <section className="bg-white pb-[120px] md:pb-[160px]">
        <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-[165px]">
