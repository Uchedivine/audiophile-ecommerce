    ...
    <main>
      ...
      <section className="bg-white pt-[79px] md:pt-[33px]">
        <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-[165px]">
          <a
            href="/speakers"
            className="text-[15px] font-medium text-black hover:text-[#D87D4A] transition-colors"
          >
            Go Back
          </a>
        </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="text-black text-[15px] font-medium leading-[25px] space-y-6">
                <p>
                  ...
                  provides a fast response rate and excellent high
                  frequencies that lower tiered bookshelf speakers cannot
                  provide. The woofers are made from aluminum that produces a
                  unique and clear sound. XLR inputs allow you to connect to a
                ...
                <p>
                  ...
                  which minimises acoustic resonance. Dual connectivity
                  allows pairing through bluetooth or traditional optical and
                  RCA input. Switch input sources and control volume at your
                  finger tips with the included wireless remote. This
                  versatile speaker is equipped to deliver an authentic
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-6">
                  ...
                  <span className="text-black text-[15px] font-medium">Speaker Unit</span>
                </li>
                <li className="flex items-start gap-6">
                  <span className="text-[#D87D4A] font-bold text-[15px] min-w-[20px]">2x</span>
                  <span className="text-black text-[15px] font-medium">Speaker Cloth Panel</span>
                </li>
                <li className="flex items-start gap-6">
                ...
                <li className="flex items-start gap-6">
                  <span className="text-[#D87D4A] font-bold text-[15px] min-w-[20px]">1x</span>
                  <span className="text-black text-[15px] font-medium">3.5mm 7.5m Audio Cable</span>
                </li>
                <li className="flex items-start gap-6">
                  <span className="text-[#D87D4A] font-bold text-[15px] min-w-[20px]">1x</span>
                  <span className="text-black text-[15px] font-medium">7.5m Optical Cable</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-14 md:gap-[30px]">
            ...
            <div className="text-center">
              ...
              <a href="/headphones/xx59">
                <button className="bg-[#D87D4A] hover:bg-[#FBAF8Adds5] text-white uppercase text-[13px] font-bold tracking-[1px] px-[31px] py-[15px] transition-colors">
                  See Product
                </button>
              </a>
            </div>
