  ...
  return (
    <main>
      ...
      <section className="bg-white pt-[79px] md:pt-[33px]">
        <div className="max-w-[1440px] mx-auto px-6 md:px-10 lg:px-[165px]">
          <a href="/speakers" className="text-[15px] font-medium text-black hover:text-[#D87D4A] transition-colors">
            Go Back
          </a>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-[125px]">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="text-black text-[15px] font-medium leading-[25px] space-y-6">
                <p>
                  Connect via Bluetooth or nearly any wired source. This
                  speaker features optical, digital coaxial, USB Type-B,
                  stereo RCA, and stereo XLR inputs, allowing you to have up
                  to five wired source devices connected for easy switching.
                  Improved bluetooth technology offers near lossless audio
                ...
                <p>
                  ...
                  Equally important is its powerful room-shaking bass
                  courtesy of a 6.5" aluminum alloy bass unit. You'll be
                  able to enjoy equal sound quality whether in a large room
                  or small den. Furthermore, you will experience new
                  sensations from old songs since it can respond to even the
                  subtle waveforms.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-start gap-6">
                  <span className="text-[#D87D4A] font-bold text-[15px] min-w-[20px]">1x</span>
                  <span className="text-black text-[15px] font-medium">3.5mm 10m Audio Cable</span>
                </li>
                <li className="flex items-start gap-6">
                  <span className="text-[#D87D4A] font-bold text-[15px] min-w-[20px]">1x</span>
                  <span className="text-black text-[15px] font-medium">10m Optical Cable</span>
                </li>
              </ul>
            </div>
          </div>
